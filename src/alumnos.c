...
bool JorgeMunoz(char * cadena, size_t espacio) {
        ...
        return SerializarAlumno(cadena, sizeof(cadena), &ALUMNO);
    }
...
bool LucianoFranciscoVittori(char * cadena, size_t espacio) {
    static const struct alumno_s ALUMNO = {
        .apellidos = "VITTORI",
...
bool KevinMoncayo(char * cadena, size_t espacio) {
    ...
    bool FredsAmundaray(char * cadena, size_t espacio) {
       static const struct alumno_s ALUMNO = {
            .apellidos = "AMUNDARAY",
            .nombres = "Freds",
...
bool MiguelAzar(char * cadena, size_t espacio) {
    static const struct alumno_s ALUMNO = {
        .apellidos = "AZAR",
        .nombres = "Miguel Augusto",
        .documento = "23.581.187",
    };
